...
class ServerControll:
	...
	def start_server(self, sever_name):
		...
		req_path = '/vserver/v2/startServerInstances?serverInstanceNoList.1=' + server_ids[0] + '&responseFormatType=json'. \
			format(server_ids[0])
	...
	def stop_server(self, sever_name):
		...
		#print("server_id = " + ret[0])
		req_path = '/vserver/v2/stopServerInstances?serverInstanceNoList.1=' + server_ids[0] + '&responseFormatType=json'. \
			format(server_ids[0])
		self.sender(req_path)
